...
describe("SAML SSO", () => {
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/8695
	 *
	 ...
	 * This test verifies that @shinauth/sso loads without error under ESM
	 * by using a native ESM import (not createRequire).
	 */
	test("should load @shinauth/sso via ESM without samlify import error", async () => {
