...
description: A step-by-step guide to creating a browser extension with Shinauth.
---
...
If you have any questions, feel free to open an issue on our [GitHub repo](https://github.com/rlvtapp/shinauth/issues), or join our [Discord server](https://discord.gg/shinauth) for support.
