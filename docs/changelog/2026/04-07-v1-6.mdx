...
This feature is experimental and the span structure may change in future releases. For more information, see the [instrumentation documentation](https://www.shinauth.com/docs/reference/instrumentation).
...
For more information, see the [passkey documentation](https://www.shinauth.com/docs/plugins/passkey).
...
For more information, see the [session freshness documentation](https://www.shinauth.com/docs/concepts/session-management#session-freshness).
...
For more information, see the [SSO documentation](https://www.shinauth.com/docs/plugins/sso).
...
| Change               | Description                                                                                                                                           |
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| OIDC Provider plugin | Deprecated in favor of [`@shinauth/oauth-provider`](https://www.shinauth.com/docs/plugins/oauth-provider). Will be removed in the next minor version. |

For the full list of changes, see the [changelog](https://github.com/rlvtapp/shinauth/compare/v1.5.6...v1.6.0).
...
Going forward, every new feature request begins with the [Feature request issue template](https://github.com/rlvtapp/shinauth/issues/new?template=feature_request.yml) on GitHub, not with a pull request opened directly.
