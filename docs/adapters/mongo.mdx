...
description: Integrate Shinauth with MongoDB.
---
...
To use the MongoDB adapter, you need to install the `@shinauth/mongo-adapter` package:

```bash
pnpm add @shinauth/mongo-adapter
```
