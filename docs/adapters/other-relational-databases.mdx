...
description: Integrate Shinauth with other relational databases.
---

Shinauth supports a wide range of database dialects out of the box thanks to [Kysely](https://kysely.dev/).

Any dialect supported by Kysely can be utilized with Shinauth, including capabilities for generating and migrating database schemas through the [CLI](/concepts/cli).
...
**Note:**
  ...
  You can see the full list of supported [Kysely dialects](https://kysely.dev/docs/dialects).
