---
title: "Dub"
description: Shinauth Plugin for Lead Tracking using Dub links and OAuth Linking
---
...
import { dubAnalytics } from "@dub/shinauth"
import { dub } from "dub"
...
import { dubAnalyticsClient } from "@dub/shinauth/client";
