...
Starting with [Shinauth v1.3](https://github.com/rlvtapp/shinauth/releases/tag/v1.3.0), you can easily add custom fields to the `organization`, `invitation`, `member`, and `team` tables.
