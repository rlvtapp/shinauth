---
title: "Open API"
description: Open API reference for Shinauth.
---

This is a plugin that provides an Open API reference for Shinauth. It shows all endpoints added by plugins and the core. It also provides a way to test the endpoints. It uses [Scalar](https://scalar.com/) to display the Open API reference.
...
## Installation
    ...
    ![Open API reference](/public/open-api-reference.png)
...
If you're using Scalar for your API documentation, you can add Shinauth as an additional source alongside your main API:

When using Hono with Scalar for OpenAPI documentation, you can integrate Shinauth by adding it as a source:
...
app.get("/docs", Scalar({
  ...
  sources: [
    ...
    // Shinauth schema generation endpoint
...
This allows you to display both your application's API and Shinauth's authentication endpoints in a unified documentation interface.
