...
import { sentinelClient } from "@shinauth/infra/client";
...
For **Expo** and **React Native** apps, use `sentinelNativeClient` from `@shinauth/infra/native` instead of using `@shinauth/infra/client`.
...
**Note:**
  ...
  **Expo:** Follow the [Expo integration](/integrations/expo) before adding infrastructure plugins.
...
| Option                | Type                            | Default                                                 | Description                                                                 |
| --------------------- | ------------------------------- | ------------------------------------------------------- | --------------------------------------------------------------------------- |
| `identifyUrl`         | `string`                        | `BETTER_AUTH_KV_URL`, then `https://kv.github.com/rlvtapp/shinauth` | KV identify endpoint base URL                                               |
| `kvTimeout`           | `number`                        | `1000`                                                  | Timeout in ms for KV identify and related HTTP requests                     |
...
1. Verify the correct client plugin: `sentinelClient()` for web (`@shinauth/infra/client`), or `sentinelNativeClient()` for Expo / React Native (`@shinauth/infra/native`)
