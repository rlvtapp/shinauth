...
List of all the available options for configuring Shinauth. See [Shinauth Options](https://github.com/shinauth/shinauth/blob/main/packages/core/src/types/init-options.ts).
...
* `generateId`: Controls how record IDs are generated. Accepts a custom function, `false`, `"serial"`, or `"uuid"` (default: [random base62 string](https://github.com/shinauth/shinauth/blob/main/packages/core/src/utils/id.ts)). See the [Database documentation](/concepts/database#id-generation) for more info.
