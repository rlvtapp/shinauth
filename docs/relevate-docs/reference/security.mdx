...
If you discover a security vulnerability in Shinauth, please report it to us at [security@github.com/rlvtapp/shinauth](mailto:security@github.com/rlvtapp/shinauth). We address all reports promptly, and credits will be given for validated discoveries.
