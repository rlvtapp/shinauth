...
* Take a look at our existing [issues](https://github.com/shinauth/shinauth/issues) and [pull requests](https://github.com/shinauth/shinauth/pulls)
...
**Warning:**
  ...
  installed, preferably on LTS.
    ...
    Visit [https://github.com/shinauth/shinauth](https://github.com/shinauth/shinauth)
...
Once you have an idea of what you want to contribute, you can start making changes. Here are some steps to get started:
    ...
    git remote add upstream https://github.com/shinauth/shinauth.git
...
* Check our [GitHub issues](https://github.com/shinauth/shinauth/issues) for tasks labeled `good first issue`
...
* Open an [issue](https://github.com/shinauth/shinauth/issues) with questions
