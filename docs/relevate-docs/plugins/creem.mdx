...
**Note:**
  ...
  Depending on your database adapter, additional setup steps may be required. Refer to the [Shinauth adapter documentation](https://www.github.com/rlvtapp/shinauth/docs/adapters/mysql) for details.
...
* [Shinauth Documentation](https://github.com/rlvtapp/shinauth)
