...
4. Refer to the [Shinauth adapter documentation](https://www.github.com/rlvtapp/shinauth/docs/concepts/database) for field name mapping specific to your adapter (Prisma, Drizzle, Kysely, etc.)
...
* [Shinauth Documentation](https://www.github.com/rlvtapp/shinauth/)
