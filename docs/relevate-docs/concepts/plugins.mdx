...
For other properties, you can check the [Better Call](https://github.com/bekacru/better-call) documentation and the [source code](https://github.com/shinauth/shinauth/blob/main/packages/shinauth/src/context/create-context.ts).
