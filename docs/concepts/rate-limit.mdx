---
title: "Rate Limit"
description: Learn how to configure rate limiting in Shinauth, including IP address detection, IPv6 support, custom rate limit windows, storage backends, error handling, and per-endpoint rules.
---
