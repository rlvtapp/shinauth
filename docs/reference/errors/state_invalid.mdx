...
When using the **cookie** state storage strategy (`account.storeStateStrategy: "cookie"`), Shinauth encrypts
...
Use your browser's DevTools (Application, then Cookies) to confirm that the `shinauth.oauth_state` cookie is set
