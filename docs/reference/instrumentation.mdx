...
description: Distributed tracing for Shinauth
---
...
Shinauth is instrumented through [OpenTelemetry](https://opentelemetry.io/) for distributed tracing. Spans are emitted for endpoints, hooks, database operations and the plugin lifecycle.
The goal of this instrumentation is to provide better insights into the behavior of your Shinauth instance, helping you debug issues and optimize performance.

## Setup

Shinauth uses the OpenTelemetry API to create spans. For traces to be collected and exported, at minimum, you must configure a **TracerProvider** and a **SpanExporter** in your application.
...
The following spans are supported by Shinauth:
