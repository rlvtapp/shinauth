...
Thank you for your interest in contributing to Shinauth! This guide is a concise guide to contributing to Shinauth.

## Getting Started

Before diving in, here are a few important resources:

* Take a look at our existing [issues](https://github.com/rlvtapp/shinauth/issues) and [pull requests](https://github.com/rlvtapp/shinauth/pulls)
* Join our community discussions in [Discord](https://discord.gg/shinauth)
...
Visit [https://github.com/rlvtapp/shinauth](https://github.com/rlvtapp/shinauth)
...
git remote add upstream https://github.com/rlvtapp/shinauth.git
...
Run the package-specific command for the area you're changing. The documentation content in `docs/` is rendered by Relevate Docs.

### 3. Make Your Changes

* Make your changes to the codebase.

* Write tests if needed. (Read more about [testing](/reference/contributing#testing))

* Update documentation. (Read more about [documenting](/reference/contributing#documentation))

### Issues and Bug Fixes

* Check our [GitHub issues](https://github.com/rlvtapp/shinauth/issues) for tasks labeled `good first issue`
...
* Open an [issue](https://github.com/rlvtapp/shinauth/issues) with questions
* Join our [community discussions](https://discord.gg/shinauth)
* Reach out to project maintainers

Thank you for contributing to Shinauth!
