---
title: Anonymous  
description: Anonymous plugin for Shinauth.
---
...
<Steps>
  <Step>
    ...
    import { anonymous } from "shinauth/plugins" // [!code highlight]
  ...
  <Step>
    ...
    import { anonymousClient } from "shinauth/client/plugins" // [!code highlight]
