---
title: Polar
description: Shinauth Plugin for Payment and Checkouts using Polar
---

[Polar](https://polar.sh) is a developer first payment infrastructure. Out of the box it provides a lot of developer first integrations for payments, checkouts and more. This plugin helps you integrate Polar with Shinauth to make your auth + payments flow seamless.
...
```bash
pnpm add shinauth @polar-sh/shinauth @polar-sh/sdk
```
...
import { polar, checkout, portal, usage, webhooks } from "@polar-sh/shinauth";
...
import { polarClient } from "@polar-sh/shinauth/client";
...
```typescript
import { polar, checkout } from "@polar-sh/shinauth";
...
```typescript
import { polar, checkout, portal } from "@polar-sh/shinauth";
...
```typescript
import { polar, checkout, portal, usage } from "@polar-sh/shinauth";
...
```typescript
import { polar, webhooks } from "@polar-sh/shinauth";
