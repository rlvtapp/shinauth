...
<Callout>
  `mcp()` ships in the `@shinauth/mcp` package. Install it with `npm install @shinauth/mcp`.
</Callout>
...
<Steps>
  <Step>
    ...
    import { jwt } from "shinauth/plugins"; // [!code highlight]
    import { mcp } from "@shinauth/mcp"; // [!code highlight]
...
import { requireMcpAuth } from "@shinauth/mcp"; // [!code highlight]
import { z } from "zod";
...
import { mcpHandler } from "@shinauth/mcp"; // [!code highlight]
