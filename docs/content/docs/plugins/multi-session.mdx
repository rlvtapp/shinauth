---
title: Multi Session
description: Learn how to use multi-session plugin in Shinauth.
---
...
<Steps>
  <Step>
    ...
    import { multiSession } from "shinauth/plugins"  // [!code highlight]
  ...
  <Step>
    ...
    import { multiSessionClient } from "shinauth/client/plugins"  // [!code highlight]
...
```ts title="auth.ts"
import { betterAuth } from "shinauth"
import { multiSession } from "shinauth/plugins"
