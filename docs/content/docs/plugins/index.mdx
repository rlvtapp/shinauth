...
| [Account Merge](/docs/plugins/account-merge)         | Merge duplicate user accounts                              |
...
Looking for more? Check out [community plugins](/docs/plugins/community-plugins) built by the Shinauth community.
