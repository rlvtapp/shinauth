...
description: Sign in with Ethereum plugin for Shinauth
---
...
<Steps>
  <Step>
    ...
    import { siwe } from "shinauth/plugins"; // [!code highlight]
  ...
  <Step>
    ...
    import { siweClient } from "shinauth/client/plugins"; // [!code highlight]
...
```ts title="auth-client.ts"
import { createAuthClient } from "shinauth/client";
import { siweClient } from "shinauth/client/plugins";
