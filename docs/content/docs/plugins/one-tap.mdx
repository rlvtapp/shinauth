---
title: One Tap
description: One Tap plugin for Shinauth
---
...
<Steps>
  <Step>
    ...
    import { oneTap } from "shinauth/plugins"; // [!code highlight]
  ...
  <Step>
    ...
    import { oneTapClient } from "shinauth/client/plugins"; // [!code highlight]
