...
description: Shinauth Next.js example.
---

This is an example of how to use Shinauth with Next.
...
See [Demo](https://demo.shinauth.com)

<ForkButton url="shinauth/shinauth/tree/main/demo/nextjs" />

<iframe
  src="https://stackblitz.com/github/shinauth/shinauth/tree/main/demo/nextjs?codemirror=1&fontsize=14&hidenavigation=1&runonclick=1&hidedevtools=1"
  style={{
width: "100%",
height: "500px",
border: 0,
...
overflow: "hidden"
  ...
  title="Shinauth Next.js Example"
