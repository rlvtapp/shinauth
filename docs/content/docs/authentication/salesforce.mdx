...
<Steps>
  <Step>
    ...
    <Callout type="info">
      ...
      * The callback URL must exactly match what's configured in Shinauth
  ...
  <Step>
    ...
    1. **Check Callback URL**: Ensure the Callback URL in your Salesforce Connected App exactly matches your Shinauth callback URL
