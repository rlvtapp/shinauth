...
description: This guide will help you integrate Shinauth Infrastructure into your application.
---
...
<Steps>
  <Step>
    ...
    1. A working [Shinauth](/docs/installation) installation
...
import { dash } from "@shinauth/infra"; // [!code highlight]
...
```ts
import { betterAuth } from "shinauth";
import { dash, sentinel } from "@shinauth/infra";  // [!code highlight]
