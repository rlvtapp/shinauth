...
In this guide, we'll walk you through the steps of creating a browser extension using <Link href="https://docs.plasmo.com/">Plasmo</Link> with Shinauth for authentication.

If you would like to view a completed example, you can check out the <Link href="https://github.com/shinauth/examples/tree/main/browser-extension-example">browser extension example</Link>.

<Callout type="warn">
  The Plasmo framework does not provide a backend for the browser extension.
  This guide assumes you have{" "}
  <Link href="/docs/integrations/hono">a backend setup</Link> of Shinauth and
...
<Steps>
  ...
  <Step>
    ...
    To learn more about the client Shinauth API, check out the <Link href="/docs/concepts/client">client documentation</Link>.
...
If you have any questions, feel free to open an issue on our <Link href="https://github.com/rlvtapp/shinauth/issues">GitHub repo</Link>, or join our <Link href="https://discord.gg/shinauth">Discord server</Link> for support.
