...
<Callout type="warn">
  This guide assumes you have <Link href="/docs/installation">setup the basics</Link> of Shinauth and are ready to create your first plugin.
</Callout>
...
<Steps>
  ...
  <Step>
    ...
    Shinauth plugins operate as a pair: a <Link href="/docs/concepts/plugins#create-a-server-plugin">server plugin</Link> and a <Link href="/docs/concepts/plugins#creating-a-client-plugin">client plugin</Link>.
  ...
  <Step>
    ...
    By creating a schema here, this also allows <Link href="/docs/concepts/cli">Shinauth’s CLI</Link> to generate the schemas required to update your database.
...
our <Link href="https://discord.gg/shinauth">Discord server</Link>,
or through a <Link href="https://github.com/rlvtapp/shinauth/pulls">pull-request</Link>
