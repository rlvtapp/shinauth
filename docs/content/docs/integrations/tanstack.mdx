...
description: Integrate Shinauth with TanStack Start.
---
...
You can create a new TanStack Start project with Shinauth integrated using the following command. This CLI sets up a project with an auth instance configured with the plugin and mounted handlers.
