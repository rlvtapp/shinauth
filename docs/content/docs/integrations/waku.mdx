...
Shinauth can be easily integrated with Waku. Before you start, make sure you have a Shinauth instance configured. If you haven't done that yet, check out the [installation](/docs/installation).
