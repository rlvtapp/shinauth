---
title: Migrate from Supabase Auth to Shinauth + PlanetScale PostgreSQL
description: This migration guide aims to guide you move your auth from Supabase Auth to Shinauth on PlanetScale PostgreSQL.
date: 2025-08-25
author:
  name: "Dagmawi Esayas"
  avatar: ""
...
# Supabase Auth to Shinauth + PlanetScale PostgreSQL Migration Guide
...
We’ve noticed that some users are migrating from Supabase to PlanetScale PostgreSQL, but facing challenges because they also rely on Supabase Auth. This guide will help you migrate your authentication from Supabase Auth to Shinauth on PlanetScale PostgreSQL.
...
<Steps>
  ...
  <Step>
    Create a [new database](https://app.planetscale.com/new?org=shinauth)
  </Step>
  ...
  <Step>
    Save the database URL in your `.env` file for later use with Shinauth:
...
<Steps>
  <Step>
    ...
    ```package-install
    npm install shinauth
    ```
  </Step>

  <Step>
    Follow and complete the [basic setup](https://www.shinauth.com/docs/installation)
  </Step>
</Steps>
...
## 4. Generate & Migrate Shinauth Schema

<Steps>
  <Step>
    Run this cli command to generate all the schema needed to setup Shinauth:
...
Now comes the fun part. You are now all setup to move your auth from Supabase Auth to Shinauth and all you have to do is go through the instances you've used Supabase Auth client and replace it with Shinauth client. We are going to see a few examples here.
...
<Callout type="info">
  ...
  guide](https://www.shinauth.com/docs/guides/supabase-migration-guide) we
  made.
</Callout>
...
You've successfully migrated from Supabase Auth to Shinauth on PlanetScale.
...
* Remember that this is just the basics and if you've integrated Supabase Auth's auth functions in a lot of placed you'd have to find the suitable [Shinauth replacements](https://www.shinauth.com/docs).
* Have fun!

### Learn More!

<Cards>
  <Card href="https://www.shinauth.com/docs/introduction" title="Shinauth Setup">
    Get started with installing Shinauth
  </Card>
  ...
  <Card href="https://www.shinauth.com/docs/guides/supabase-migration-guide" title="Supabase Auth Migration">
