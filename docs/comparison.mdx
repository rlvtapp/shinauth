---
title: "Comparison"
description: Comparison of Shinauth versus over other auth libraries and services.
---

> <p className="text-orange-400 dark:text-orange-200">Comparison is the thief of joy.</p>

Here are non detailed reasons why you may want to use Shinauth over other auth libraries and services.
