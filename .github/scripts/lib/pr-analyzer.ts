...
const PATH_TO_DOMAIN: [string, string][] = [
	...
	// Catch-all for shinauth and core packages
...
const PATH_TO_PACKAGE: [string, string][] = [
	...
	// Catch-all: everything in shinauth or core maps to the main package
...
export function resolvePackage(
	...
	// If all files are in shinauth, return shinauth.
	return packages.sort((a, b) => {
		// Prefer non-shinauth packages (they're more specific)
