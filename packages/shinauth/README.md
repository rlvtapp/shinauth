<div align="center">
  <picture>
    <source srcset="https://github.com/rlvtapp/shinauth/blob/main/banner-dark.png?raw=true" media="(prefers-color-scheme: dark)"/>
    <source srcset="https://github.com/rlvtapp/shinauth/blob/main/banner-light.png?raw=true" media="(prefers-color-scheme: light)"/>
    <img src="https://github.com/rlvtapp/shinauth/blob/main/banner-light.png?raw=true" alt="Shinauth Logo"/>
  </picture>
