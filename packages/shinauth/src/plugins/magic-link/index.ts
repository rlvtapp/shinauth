...
export const magicLink = (options: MagicLinkOptions) => {
	...
	if (options.allowedAttempts !== undefined && options.allowedAttempts !== 1) {
		console.warn(
			"[shinauth/magic-link] `allowedAttempts` is ignored: tokens are consumed atomically on the first verification call. Any value other than `1` has no effect; remove the option to silence this warning.",
		);
	}
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://shinauth.com/docs/plugins/sign-in#api-method-sign-in-magic-link)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://shinauth.com/docs/plugins/magic-link#api-method-magic-link-verify)
			 */
