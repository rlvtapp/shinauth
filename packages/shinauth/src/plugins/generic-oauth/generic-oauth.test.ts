...
describe("oauth2", async () => {
	 ...
	 *
	 * @see https://github.com/rlvtapp/shinauth/issues/6086
	 */
	 ...
	 *
	 * @see https://github.com/rlvtapp/shinauth/issues/7703
	 */
	 ...
	 *
	 * @see https://github.com/rlvtapp/shinauth/issues/7554
	 */
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/9486
	 */
	it("blocks the session with error=email_not_verified when requireEmailVerification is set", async () => {
		...
		expect(setCookieHeader).not.toContain("shinauth.session_token=");
	});
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/9702
	 */
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/9124
	 */
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/8897
	 */
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/pull/4951
	 * @see https://github.com/rlvtapp/shinauth/pull/9069
	 */
	...
	describe("Yandex Provider Helper", () => {
		...
		/**
		 * @see https://github.com/rlvtapp/shinauth/pull/10278#discussion_r3495058505
		 */
	...
	describe("id_token verification", () => {
		...
		/**
		 * @see https://github.com/rlvtapp/shinauth/issues/7571
		 */
		...
		/**
		 * @see https://github.com/rlvtapp/shinauth/pull/10095#discussion_r3417330694
		 */
...
/**
 * @see https://github.com/rlvtapp/shinauth/issues/4151
 * @see https://github.com/rlvtapp/shinauth/issues/9593
 */
