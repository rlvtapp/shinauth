import type { BaseURLConfig, DynamicBaseURLConfig } from "@shinauth/core";
 ...
 * `@shinauth/core/utils/host` classifier here: its `utils/ip` dependency
 ...
 * `isLoopbackHost` from `@shinauth/core/utils/host`. This helper's only
