...
describe("general types", async () => {
	 ...
	 *
	 * @see https://github.com/rlvtapp/shinauth/pull/8466
...
/**
 * @see https://github.com/rlvtapp/shinauth/issues/8823
 */
...
describe("public type exports", () => {
	it("should export JoinOption from shinauth/types", () => {
		expectTypeOf<JoinOption>().not.toBeAny();
	});

	it("should export JoinConfig from shinauth/types", () => {
		expectTypeOf<JoinConfig>().not.toBeAny();
	});

	it("should export GoogleProfile from shinauth/types", () => {
