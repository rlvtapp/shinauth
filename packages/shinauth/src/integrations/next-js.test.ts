...
describe("next-js integration", () => {
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/8464
	 */
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/8828
	 */
	it("should not leak __shinauth-cookie-store cookie", async () => {
		vi.doMock("next/headers.js", () => ({
			cookies: vi.fn(async () => ({
				set: vi.fn(),
				delete: vi.fn(),
		...
		const hasProbeCookie = setCookies.some((c) =>
			c.includes("__shinauth-cookie-store"),
		);
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/9705
	 */
