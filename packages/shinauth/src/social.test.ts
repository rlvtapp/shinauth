...
describe("Social Providers", async (c) => {
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/5441
	 */
	 ...
	 *
	 * @see https://github.com/rlvtapp/shinauth/issues/9215
	 */
	 ...
	 *
	 * @see https://github.com/rlvtapp/shinauth/issues/5467
	 */
...
/**
 * @see https://github.com/rlvtapp/shinauth/issues/4498
 */
...
describe("validateUserInfo callback", async () => {
	...
	it("re-validates a returning OAuth user against the fresh provider identity", async () => {
		...
		// while keeping the Shinauth user id instead of the provider account id.
 ...
 *
 * @see https://github.com/rlvtapp/shinauth/pull/3013
 */
...
/**
 * @see https://github.com/rlvtapp/shinauth/issues/9326
 */
