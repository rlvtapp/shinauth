...
/**
 * @see https://github.com/rlvtapp/shinauth/issues/8420
 */
describe("useAuthQuery - error handling", () => {
	...
	afterEach(() => {
		vi.useRealTimers();
		vi.restoreAllMocks();
		delete (globalThis as any)[Symbol.for("shinauth:broadcast-channel")];
		delete (globalThis as any)[Symbol.for("shinauth:focus-manager")];
		delete (globalThis as any)[Symbol.for("shinauth:online-manager")];
	});
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/9077
	 */
	 ...
	 * https://github.com/rlvtapp/shinauth/issues/9077: multiple
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/pull/10015#discussion_r3400409998
	 */
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/issues/9613
	 */
