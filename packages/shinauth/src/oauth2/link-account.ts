			...
			if (
				...
				if (isDevelopment()) {
					c.context.logger.warn(
						`User already exist but account isn't linked to ${account.providerId}. To read more about how account linking works in Shinauth see https://github.com/rlvtapp/shinauth`,
					);
				}
				return {
