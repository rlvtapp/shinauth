...
import { isDevelopment } from "@shinauth/core/env";
			...
			if (
				...
				if (isDevelopment()) {
					c.context.logger.warn(
						`User already exist but account isn't linked to ${account.providerId}. To read more about how account linking works in Shinauth see https://www.shinauth.com/docs/concepts/users-accounts#account-linking.`,
					);
				}
				return {
