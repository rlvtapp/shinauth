...
describe("oauth2 - email verification on link", async () => {
	...
	/**
	 * @see https://github.com/rlvtapp/shinauth/security/advisories/GHSA-g38m-r43w-p2q7
	 */
...
/**
 * @see https://github.com/rlvtapp/shinauth/issues/7806
 */
...
/**
 * @see https://github.com/rlvtapp/shinauth/issues/8742
 */
...
/**
 * @see https://github.com/rlvtapp/shinauth/issues/8906
 *
...
describe("oauth2 - providers without email", async () => {
	...
	describe("with mapProfileToUser omitting provider id", async () => {
		...
		/**
		 * @see https://github.com/rlvtapp/shinauth/issues/9454
		 */
...
describe("oauth2 - per-provider requireEmailVerification gate", async () => {
	...
	function sessionToken(setCookie: string) {
		return parseSetCookieHeader(setCookie).get("shinauth.session_token")
			?.value;
	}
...
/**
 * @see https://github.com/rlvtapp/shinauth/issues/9959
 */
